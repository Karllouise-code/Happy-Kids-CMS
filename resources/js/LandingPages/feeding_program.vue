    ...
    <section class="hk-section">
      <div class="hk-container">
        ...
        <div class="hk-split">
          ...
          <div>
            <img :src="imgSrc(`/uploads/pages/program_/feeding-program/${pages.description?.program_image_webp}`)" :alt="pages?.description?.program_intro_title" @error="imgFallback" />
          </div>
        </div>
      </div>
    </section>
